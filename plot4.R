...
plot(HW$blah, HW$Global_active_power, type="l", xlab=NA, ylab="Global Active Power")
...
plot(HW$blah,HW$Voltage, type="l", xlab="datetime", ylab="Voltage")
plot(HW$blah,HW$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
